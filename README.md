...
This repository contains the material for the exam "Introduction to Parallel Computing" (University of Trento). Inside the deliverable folders there are the instructions for reproducibility.
